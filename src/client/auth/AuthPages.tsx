...
function AuthFrame({ mode }: { mode: 'login' | 'register' }) {
  ...
  return <main className="safe-top flex min-h-dvh items-center justify-center px-4 pb-8 sm:px-6"><div className="animate-enter grid w-full max-w-5xl overflow-hidden rounded-[1.75rem] border border-white/60 bg-surface shadow-[0_24px_70px_rgba(18,42,43,.13)] md:grid-cols-[1.05fr_.95fr]">
