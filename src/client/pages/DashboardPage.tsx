...
export default function DashboardPage() {
  ...
  labels.set('spending', t('Actual spending')); labels.set('income', t('Income')); labels.set('utility', t('Utility impact')); labels.set('growth', t('Asset gain change'));
